...
class DrawableUtil private constructor() {
    companion object {
         ...
         * @return 状态选择器
         */
        val randomColorDrawable: StateListDrawable
            get() = getRandomColorDrawable(10)
         ...
         * @return 状态选择器
         */
        val strokeRandomColorDrawable: StateListDrawable
            get() = getStrokeSolidDrawable(10, 4, ColorUtil.getRandomColor(), Color.TRANSPARENT)
